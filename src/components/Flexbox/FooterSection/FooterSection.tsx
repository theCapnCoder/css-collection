      ...
      <footer className={styles.container}>
        <div className={clsx(styles.sec, styles.aboutUs)}>
          ...
          <p>
            ...
            eligendi et consequatur ut aliquid, officia quas ab dolore excepturi
            pariatur quia numquam accusamus. Consequuntur voluptate illo quasi
            Dignissimos distinctio repellat repudiandae dolorem obcaecati.
            laborum, quidem dolorum voluptates provident debitis ullam iste fuga
            minus voluptatum vero.
          </p>
